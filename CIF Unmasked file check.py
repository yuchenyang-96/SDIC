...
#7b. Check Customer name. 1st position is letter, last position is space
    ...
    if namecheck == True and namelastposition == True:
...
#7h. Check Postal code
    for y in range(423,429):
        postalcodechars = dtl_row[y].isnumeric()
        if postalcodechars == True:
            print("...")
        else:
    ...
    if postalcodechars == True and postalcodespace == True:
...
#7k. Check mobile number
    mobileprefixcheck = dtl_row[440:442] == convert('65')
