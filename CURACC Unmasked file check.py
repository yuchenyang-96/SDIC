...
prefix = first_row[25:31] == convert("CURACC")
...
filedesccheck = first_row[45:75] == convert('Current Account File          ')
...
currencycodecheck = first_row[105:108] == convert("SGD")
if currencycodecheck == True:
    f2.write("Currency code is CORRECT. \n")
else:
    f2.write("Currency code is WRONG. \n")

# Check corresponding GL account number (blanks for now)
glcheck = first_row[108:143] == convert(" "*35)
if glcheck == True:
    f2.write("Corresponding GL account number has CORRECT format (Filler).\n")
else:
    f2.write("Corresponding GL account number has WRONG format (Filler).\n")

# Check filler format
fillercheck = first_row[143:160] == convert(" "*17)
if fillercheck == True:
...
tlrledgercheck = last_row[18:52] == convert("0000000000000000000000000000.00000")

if tlrledgercheck == True:
    f2.write("Ledger balance format is CORRECT.\n")
else:
    f2.write("Ledger balance format is WRONG.\n")
